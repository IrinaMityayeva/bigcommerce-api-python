...
from bigcommerce_v3.resources import ApiResource
...
class TestBigcommerceApi(unittest.TestCase):
    ...
    def test_create_basic(self):
        api = bigcommerce_v3.api.BigcommerceApi(host='store.mybigcommerce.com', basic_auth=('admin', 'abcdef'))
    ...
    def test_create_oauth(self):
        api = bigcommerce_v3.api.BigcommerceApi(client_id='123456', store_hash='abcdef', access_token='123abc')
    ...
    def test_create_incorrect_args(self):
        self.assertRaises(Exception, lambda: bigcommerce_v3.api.BigcommerceApi(client_id='123', basic_auth=('admin', 'token')))
...
class TestApiResourceWrapper(unittest.TestCase):
    ...
    def test_create(self):
        ...
        wrapper = bigcommerce_v3.api.ApiResourceWrapper('ApiResource', api)
    ...
    def test_str_to_class(self):
        cls = bigcommerce_v3.api.ApiResourceWrapper.str_to_class('ApiResource')
        self.assertEqual(cls, ApiResource)

        self.assertRaises(AttributeError, lambda: bigcommerce_v3.api.ApiResourceWrapper.str_to_class('ApiResourceWhichDoesNotExist'))
